...
df_ini = pd.read_csv(f"JJA_ini.csv").iloc[1:]
...
nc_file = nc.Dataset("bm_solar_input.nc", mode="w", datamodel="NETCDF4", clobber=True)
...
# Surface settings
df_surf = pd.read_csv(f"JJA_ini.csv").iloc[0]
